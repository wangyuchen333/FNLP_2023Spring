...
class Parser(object):
    ...
    def __init__(self, dataset):
        ...
        deprel = ['root', 'ccomp', 'parataxis', 'acl', 'dep', 'conj', 'cc', 'det:predet', 
                  'mark', 'nmod:poss', 'compound:prt', 'amod', 'nmod:tmod', 'mwe', 'expl', 
                  'csubjpass', 'punct', 'nummod', 'nsubjpass', 'nmod', 'case', 'dobj',
                  'compound', 'advmod', 'appos', 'auxpass', 'neg', 'acl:relcl', 'iobj', 
                  'aux', 'nmod:npmod', 'cc:preconj', 'discourse', 'cop', 'csubj', 'advcl', 'nsubj', 'det', 'xcomp']
        ...
        # # 打印字典的前100个键值对
        # sorted_items = sorted(tok2id.items(), key=lambda x: x[1])
        ...
        # for idx, (key, value) in enumerate(itertools.islice(tok2id.items(), 1000, 1100), start=1000):
        #     print(idx, key, value)
    ...
    def create_instances(self, examples):
        ...
        for id, ex in enumerate(examples):
            ...
            for i in range(n_words * 2):
                ...
                # assert legal_labels[gold_t[0]] == 1
